...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Record.replay_url'
        db.add_column('records_record', 'replay_url',
                      self.gf('django.db.models.fields.URLField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Record.replay_url'
        db.delete_column('records_record', 'replay_url')
    ...
    models = {
        ...
        'records.record': {
            ...
            'replay_url': ('django.db.models.fields.URLField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
